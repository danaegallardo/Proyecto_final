...
<body>
<h1 class="mi-h1">[AISLAHOME]</h1>
    <div class="container">
        <a href="src/login.php" class="btn btn-small btn-success"><i class="fa-solid fa-user fa-bounce"></i></a>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="src/productos.html">Productos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="src/proyectos.html">Proyectos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="src/quienesSomos.html">Quienes Somos</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <!--parrafo-->
            <!--mapa-->
            <div class="map-container" class="col-md-6 col-sm-12">
                <iframe
    ...
    <div>
        <footer>
            ...
            <p>© AislaHome 2023</p>
            <a href="src/login_trabajador.php">Panel Admin</a>
        </footer>
    </div>
